...
ego4d_dataset = nnet.datasets.EGO4D(None, None, version="EGO4D", download=True, prepare=False, tokenizer_path=tokenizer_path, mean_face_path=mean_face_path, workers_prepare=2, mode="train")
